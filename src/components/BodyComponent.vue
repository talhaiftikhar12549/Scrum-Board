...
<!--      </div>-->
<!--    </div>-->
<!--    &lt;!&ndash;    Show Modal Ends&ndash;&gt;-->

<!--    &lt;!&ndash;Edit Modal Start&ndash;&gt;-->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form @submit.prevent="dataSendToBacklog">
              ...
              <div class="mb-3">
                <select v-model="selectedItem.priority" required class="form-select" aria-label="Default select example">
                  <option disabled value="">Select Task Priority</option>
                  <option value="low">Low</option>
                  <option value="high">High</option>
                  <option value="urgent">Urgent</option>
